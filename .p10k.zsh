# Generated by Powerlevel10k configuration wizard on 2020-12-16 at 09:56 EST.
...
() {
  ...
  typeset -g POWERLEVEL9K_MULTILINE_FIRST_PROMPT_PREFIX='%F{031}╭─'
  typeset -g POWERLEVEL9K_MULTILINE_NEWLINE_PROMPT_PREFIX='%F{031}├─'
  typeset -g POWERLEVEL9K_MULTILINE_LAST_PROMPT_PREFIX='%F{031}╰  ﬦ%f '
  ...
  # typeset -g POWERLEVEL9K_BACKGROUND=196
  ...
  typeset -g POWERLEVEL9K_CUSTOM_OS_ICON='echo %F{196}  %F{172}jon%F{014}::%F{035}' #skull
  typeset -g POWERLEVEL9K_CUSTOM_OS_ICON_BACKGROUND=0
  typeset -g POWERLEVEL9K_CUSTOM_OS_ICON_FOREGROUND=172
  ...
  typeset -g POWERLEVEL9K_DIR_FOREGROUND=82
  ...
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND=82
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local       meta='%31F'  # grey foreground
  ...
  typeset -g POWERLEVEL9K_VCS_GIT_GITHUB_ICON='%F{031}'
  typeset -g POWERLEVEL9K_VCS_GIT_GITHUB_ICON_COLOR=31
  # Custom prefix.
  ...
  typeset -g POWERLEVEL9K_VCS_CLEAN_FOREGROUND=31
  typeset -g POWERLEVEL9K_VCS_UNTRACKED_FOREGROUND=31
  ...
  ######################################[ ram: free RAM ]#######################################
  # RAM color.
  typeset -g POWERLEVEL9K_RAM_FOREGROUND=82
  typeset -g POWERLEVEL9K_RAM_BACKGROUND=16
  # Custom icon.
  # typeset -g POWERLEVEL9K_RAM_VISUAL_IDENTIFIER_EXPANSION='⭐'
  typeset -g POWERLEVEL9K_RAM_VISUAL_IDENTIFIER_EXPANSION='龍 '
  # typeset -g POWERLEVEL9K_RAM_ICON='龍 '
